...
### ResponseEntity
- spring framework에서 제공하는 클래스 중 http 요청 또는 response 응답에 해당하는 httpheader와 httpbody를 포함하는HttpEntity라는 클래스가 존해합니다. 
...
### RestController
- 반면에 RestController는 클라이언트의 요청(http request)
---
